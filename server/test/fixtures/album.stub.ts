...
export const albumStub = {
  ...
  dynamicWithTags: Object.freeze({
    id: 'album-dynamic-1',
    albumName: 'Dynamic album with tags',
    description: 'Album with tag filters',
    ownerId: authStub.admin.user.id,
    owner: userStub.admin,
    assets: [],
    albumThumbnailAsset: null,
  ...
  dynamicWithMultipleFilters: Object.freeze({
    id: 'album-dynamic-2',
    albumName: 'Dynamic album with multiple filters',
    description: 'Album with tags, people, and date range',
    ownerId: authStub.admin.user.id,
    owner: userStub.admin,
    assets: [],
    albumThumbnailAsset: null,
